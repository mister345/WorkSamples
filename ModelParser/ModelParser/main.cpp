...
*				  and as a simple .txt file containing lists of vertices, indices, and normal   *
*				  values for use with my 3D game engine.									    *
*                                                                                               *
* Description:    Output file formats are .BinaryMesh and .txt. The BinaryMesh format was       *
*			      created because it makes for much faster loading of 3D meshes into the main   *
*				  game engine. 																	*
    ...
    *******************************************************************************/
	...
	while(!fin.eof())
	{
		if(input == 'v')
		{
            ...
            // TODO: for loading the binary, should manually skip the z value of teach texcoord
			// Read in the texture uv coordinates.
			if(input == 't') 
			{ 
				fin >> texcoords[texcoordIndex].x >> texcoords[texcoordIndex].y;
