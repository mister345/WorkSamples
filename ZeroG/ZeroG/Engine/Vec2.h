...
*                                                                                     *
* Description:    The Vec2 class contains functions to calculate more advanced        *
*                 vector-based mathematics for handling more advanced collision       *
*                 detection, trajectory calculation, and drawing that are the         *
