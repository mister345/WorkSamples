...
#include "Spawner_ON.h"

ASpawner_ON::ASpawner_ON()
	:
	...
	m_classType(AParticle::StaticClass())
{
	...
	m_pPooler = CreateDefaultSubobject<UObjectPooler_ON>( TEXT( "ObjectPooler_ON" ) );
}

void ASpawner_ON::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ASpawner_ON::Tick( float DeltaTime )
{
